...
# ============================================
# Dependency Checks (Modules, CLI Tools, EXEs)
# ============================================
$checks = @(
    # CLI checks
    ...
    @{ Name = "az";                       Type = "CLI";        Install = 'winget install -e --id Microsoft.AzureCLI (or manual: https://learn.microsoft.com/cli/azure/install-azure-cli)' }
    ...
    @{ Name = "SQLServer";                Type = "Module";     Install = 'Install-Module -Name SQLServer -Scope CurrentUser' }
