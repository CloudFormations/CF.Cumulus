...
EXEC ##AddStages 'Dimension', 'Transform cleansed data and apply business logic for Dimensions.', 1
EXEC ##AddStages 'Fact', 'Transform cleansed data and apply business logic for Facts.', 1
...
EXEC ##AddBatchStageLink 'Daily', 'Dimension'
EXEC ##AddBatchStageLink 'Daily', 'Fact'
