...
EXEC ##AddNotebooks 'Unmanaged', 'UnmanagedQuery', '/Workspace/Shared/Live/files/transform/unmanagednotebooks/UnmanagedQuery', 1
EXEC ##AddNotebooks 'Unmanaged', 'CreateDimDate', '/Workspace/Shared/Live/files/transform/unmanagednotebooks/CreateDimDate', 1
EXEC ##AddNotebooks 'Unmanaged', 'CreateDimProducts', '/Workspace/Shared/Live/files/transform/unmanagednotebooks/CreateDimProducts', 1
EXEC ##AddNotebooks 'Unmanaged', 'CreateFactSales', '/Workspace/Shared/Live/files/transform/unmanagednotebooks/CreateFactSales', 1
