...
def default_payload() -> dict:
    payload = {
        ...
        "FilterCondition": "",
        "RawSourcePath": "folder",
        "RawSourceName": "testdataset",
        "CleansedSourcePath": "test_folder",
        "CleansedSourceName": "cleanseddataset",
        }
    return payload
