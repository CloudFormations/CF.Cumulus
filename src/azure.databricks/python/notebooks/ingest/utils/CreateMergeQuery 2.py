...
def format_exploded_column_as_hashed_value(_format: str) -> str:
    return hashlib.sha256(_format.encode()).hexdigest()

# COMMAND ----------

def format_column_name_remove_forbidden_characters(column: str) -> str:
