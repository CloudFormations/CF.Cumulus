...
param(
    ...
    [string] $templateFile = "samples/demo/infrastructure/main.bicep",
    
    [Parameter(Mandatory = $false)]
    [string] $parametersFile = "samples/demo/infrastructure/configuration/_installation/main.bicepparam"
)
