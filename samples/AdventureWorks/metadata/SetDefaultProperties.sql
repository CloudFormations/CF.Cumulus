CREATE PROCEDURE [samples].[SetDefaultProperties]
AS
BEGIN
	EXEC [samples].[AddProperty]
	...
	EXEC [samples].[AddProperty]
		@PropertyName = N'PipelineAuthenticationMethod',
		@PropertyValue = N'ManagedIdentity',
	...
	EXEC [samples].[AddProperty]
		...
		@PropertyValue = N'CF.Cumulus.Samples',
