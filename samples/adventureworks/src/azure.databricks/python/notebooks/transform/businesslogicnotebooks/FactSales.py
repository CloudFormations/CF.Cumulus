...
str_sql = """
    ...
    LEFT JOIN 
        hive_metastore.dim.product pr ON sod.ProductID = pr.ProductKey
    LEFT JOIN 
        hive_metastore.dim.date od ON soh.OrderDate = od.Date
    LEFT JOIN 
        hive_metastore.dim.date dd ON soh.DueDate = dd.Date
    LEFT JOIN 
        hive_metastore.dim.date sd ON soh.ShipDate = sd.Date
"""
